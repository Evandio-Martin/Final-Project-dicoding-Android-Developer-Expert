...
class MovieRepositoryTest {
    ...
    fun getAllMovies() {
        ...
        val movieEntity = Resource.Success(PagedListUtil.mockPagedList(DataDummy.generateMovieDummy()))
    ...
    fun getAllTvShows() {
        ...
        val tvShowEntity = Resource.Success(PagedListUtil.mockPagedList(DataDummy.generateTvShowDummy()))
